...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            //删除
            function deleteFee(ee) {
                var r = window.confirm("确定要删除此资费吗？");
                if(r){
                	location.href='toDeleteCost.do?id='+ee.id;
                }
            //    document.getElementById("operate_result_info").style.display = "block";
            }
        </script>        
    ...
    <body>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    ...
                    <!-- 
                    	当前地址:/netctoss/findAll.do
                    	目标地址:/netctoss/toAddCost.do
                     -->
                       ...
                       <c:forEach items="${costs }" var="c">      
                        <tr>
                            ...
                            <td>                                
                                ...
                                <!--  
                               <a href='toDeleteCost.do?id=${c.costId}' onclick="return confirm('测试')">测试</a>
                               -->
                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateCost.do?id=${c.costId}';" />
                                <input type="button" value="删除" class="btn_delete" id="${c.costId}" onclick="deleteFee(this);" />
                            </td>
                        </tr>
        ...
        <!--主要区域结束-->
        <div id="footer">
            <p>[ © wp 使用前必读 意见反馈 京ICP证030173号]</p>
            <p>版权所有,违者必究 </p>
        </div>
    </body>
</html>
